...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-yurp30*4!eq%j8pka-l#j&*k0d*yzz4vqojp#6nx)e1hf@+#)%')

# SECURITY WARNING: don't run with debug turned on in production!
# True if running locally, False if running on Render
DEBUG = os.environ.get('RENDER', False) == False

ALLOWED_HOSTS = ['*'] # Allowed hosts for production and local
